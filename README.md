...
The chapter advisor and School/ROP signatures come pre-signed on the blank, so they are not the student's responsibility and are not checked. Eight lines may be left blank, since a blank means the same as N/A there. Those are known allergies, special medication, history of heart condition and the rest, physical restrictions, other conditions, the tetanus date, insurance company and policy number. They are still read when filled but never flagged. The family doctor and doctor's phone are required.
